...
damaBrancaCoroada::damaBrancaCoroada(int px, int py):pecasDama(px,py)
{
    setTurno(false);
    setTipo(3);
}

void damaBrancaCoroada::criaPeca(QPainter &painter,tabDama *tab)
{
...
void damaBrancaCoroada::movimento(QPainter &painter, tabDama *tab)
{
...
bool damaBrancaCoroada::podeIr(int x, int y, tabDama *tab)
{
